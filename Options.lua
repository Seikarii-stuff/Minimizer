...
-- Interface Options) con un botón que abre el mismo menú que /simp.
...
local function CreateInterfaceOptionsPanel()
    ...
    description:SetText("Abre el menú flotante de Minimizer desde el panel de AddOns. También puedes usar /simp desde el chat en cualquier momento.")
    ...
    openButton:SetText("Open Simp Menu")
    openButton:SetScript("OnClick", OpenSimpMenu)
    ...
    slashHint:SetText("Atajo de chat: /simp")
