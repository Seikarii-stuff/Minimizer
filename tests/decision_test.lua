...
Mocks.CreateTestUnit("d_cast_uninterr", {
    level = 70, classification = "rare", faction = "Horde",
...
Mocks.CreateTestUnit("d_aggro", { level = 70, classification = "rare", faction = "Horde", threatSituation = 3 })
...
Mocks.CreateTestUnit("d_normal", { level = 70, classification = "normal", faction = "Horde", powerType = 1 })
simplify, reason = addonTable.Decision.ShouldSimplifyUnit("d_normal", nil)
check(simplify == false and reason == "no simp", "Decision: normal melee queda protegido contra simplificacion")
