...
--     "Globe of Frost"; el interrupt real es "Quell".
--   - Eliminado: Nemesis (200166) de DEMONHUNTER.OFFENSIVE_CDS.
--   - Corregidos en la auditoría 12.1: Netherwalk, Convoke, Ascendance,
--     Binding Shot y la clasificación de Emerald Communion.
--   - Añadido: Breath of Eons para Augmentation Evoker.
-- ============================================================================
...
Minimizer.Data.INTERRUPT_SPELLS = {
    ...
    -- Command Demon is the player button that morphs into the active demon's
    -- ability. Mortal Coil is CC, not an interrupt, so it does not belong here.
    WARLOCK = { { id = 19647, name = "Spell Lock" }, { id = 89766, name = "Axe Toss" } },
    MONK = { { id = 116705, name = "Spear Hand Strike" } },
    DRUID = { { id = 106839, name = "Skull Bash" }, { id = 78675, name = "Solar Beam" } },
    DEATHKNIGHT = { { id = 47528, name = "Mind Freeze" } },
    PALADIN = { { id = 96231, name = "Rebuke" } },
    DEMONHUNTER = { { id = 183752, name = "Disrupt" } },
    EVOKER = { { id = 351338, name = "Quell" } },
}
...
Minimizer.Data.OFFENSIVE_CDS = {
    ...
    SHAMAN = {
        { id = 1219480, name = "Ascendance (Elemental)" },
        { id = 344548, name = "Ascendance (Enhancement)" },
        { id = 204945, name = "Doom Winds" },
    ...
    DRUID = { { id = 102558, name = "Incarnation" }, { id = 194223, name = "Celestial Alignment" }, { id = 391528, name = "Convoke the Spirits" } },
    DEMONHUNTER = {
